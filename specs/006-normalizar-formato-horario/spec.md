...
- **FR-005**: El sistema DEBE aplicar una conversión explícita de zona horaria (a hora de Argentina) al registrar horarios en el origen de datos (servidor de base de datos), sin depender de confirmar previamente la configuración de zona horaria del servidor, de forma que la hora local mostrada al usuario sea exacta y no arrastre un desfasaje no detectado.
